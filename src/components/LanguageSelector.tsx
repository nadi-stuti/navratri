  ...
  return (
    <div className={`language-selector ${className}`} ref={dropdownRef}>
      <button
        ...
        disabled={isLoading}
        aria-label={t('accessibility:ariaLabels.languageSelector.selectLanguage', 'Select Language')}
        aria-expanded={isOpen}
        aria-haspopup="listbox"
        title={t('accessibility:ariaLabels.languageSelector.selectLanguage', 'Select Language')}
      >
      ...
      {isOpen && (
        <div
          ...
          role="listbox"
          aria-label={t('accessibility:ariaLabels.languageSelector.availableLanguages', 'Available Languages')}
        >
