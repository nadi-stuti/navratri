...
export const fastingScriptures: ScriptureReference[] = [
  {
    ...
    transliteration: {
      ...
      bn: "উপবাসেন শুদ্ধ্যন্তি মনসা চ শুভাশুভে। তপসা চ শরীরং চ ব্রহ্মচর্যেণ চেন্দ্রিয়াঃ॥"
    },
    translation: {
      ...
      bn: "উপবাসের মাধ্যমে মন ভালো ও খারাপ চিন্তা থেকে শুদ্ধ হয়। তপস্যার মাধ্যমে শরীর শুদ্ধ হয় এবং ব্রহ্মচর্যের মাধ্যমে ইন্দ্রিয় নিয়ন্ত্রিত হয়।"
    },
    source: {
      en: "Garuda Purana",
      hi: "गरुड़ पुराण",
  ...
  },
  {
    ...
    transliteration: {
      ...
      bn: "ব্রতানি হি মহাদেবি সর্বপাপপ্রণাশিনী। ব্রতেন লভতে সর্বং ব্রতেন পরমং পদম্॥"
    },
    translation: {
      ...
      bn: "হে মহাদেবী, ব্রত সকল পাপ ধ্বংস করে। ব্রতের মাধ্যমে সব কিছু লাভ হয় এবং ব্রতের মাধ্যমে পরম পদ লাভ হয়।"
    },
    source: {
  ...
  },
  {
    ...
    transliteration: {
      ...
      bn: "নবরাত্রে মহাপূজ্যে দেব্যাঃ পূজনমুত্তমম্। ব্রতেন তপসা দানৈর্ভক্ত্যা চ সুসমাহিতা॥"
    },
    translation: {
      ...
      bn: "সর্বাধিক পবিত্র নবরাত্রিতে দেবীর পূজা সর্বোত্তম। ব্রত, তপস্যা, দান ও ভক্তির মাধ্যমে ব্যক্তি সুসমাহিত হয়ে ওঠে।"
    },
    source: {
...
export const navratriFastingRules: FastingRule[] = [
  {
    ...
    description: {
      ...
      bn: "উপবাসের সময় গম, চাল, বার্লি এবং অন্যান্য নিয়মিত শস্য খাওয়া হয় না"
    },
    category: "dietary",
  ...
  },
  {
    ...
    description: {
      ...
      bn: "বাকউইট (কুট্টু), জল চেস্টনাট আটা (সিঙ্গাড়া), অ্যামারান্থ (রাজগিরা) এবং বার্নইয়ার্ড বাজরা (সামা) অনুমোদিত"
    },
    category: "dietary",
  ...
  },
  {
    ...
    title: {
      ...
      bn: "পেঁয়াজ ও রসুন এড়িয়ে চলুন"
    },
    description: {
      ...
      bn: "পেঁয়াজ, রসুন এবং অন্যান্য তামসিক খাবার যা আবেগ ও অজ্ঞতা বাড়ায় সেগুলো এড়ানো হয়"
    },
    category: "dietary",
    importance: "mandatory"
  },
  {
    ...
    title: {
      ...
      bn: "শুধুমাত্র পাথরের লবণ ব্যবহার করুন"
    },
    description: {
      ...
      bn: "নিয়মিত টেবিল লবণ এড়ানো হয়; উপবাসের সময় শুধুমাত্র পাথরের লবণ (সেন্ধা নমক) ব্যবহার করা হয়"
    },
    category: "dietary",
    importance: "mandatory"
  },
  {
    ...
    title: {
      ...
      bn: "ফল ও দুগ্ধজাত পণ্য অনুমোদিত"
    },
    description: {
      ...
      bn: "সব তাজা ফল, দুধ, দই, পনির এবং অন্যান্য দুগ্ধজাত পণ্য খাওয়া যেতে পারে"
    },
    category: "dietary",
    importance: "recommended"
  },
  {
    ...
    description: {
      ...
      bn: "কিছু ভক্ত প্রার্থনার পর সন্ধ্যায় শুধুমাত্র একবেলা খাবার সহ সম্পূর্ণ উপবাস পালন করেন"
    },
    category: "timing",
    importance: "optional"
  }
...
export const navratriFastingInformation: FastingInformation = {
  reasonsForFasting: {
    spiritual: {
      ...
      bn: "উপবাস মন ও আত্মাকে শুদ্ধ করে, আধ্যাত্মিক সচেতনতা বাড়ায় এবং দেবী দুর্গার দিব্য নারী শক্তির সাথে সংযোগ স্থাপনে সাহায্য করে"
    },
    physical: {
      ...
      bn: "উপবাস শরীরকে বিষমুক্ত করে, হজমশক্তি উন্নত করে, রোগ প্রতিরোধ ক্ষমতা বাড়ায় এবং পরিপাকতন্ত্রকে বিশ্রাম দেয়"
    },
    mental: {
      ...
      bn: "উপবাস মানসিক স্পষ্টতা বাড়ায়, একাগ্রতা উন্নত করে, আত্ম-শৃঙ্খলা গড়ে তোলে এবং মানসিক চাপ ও উদ্বেগ কমায়"
    },
    cultural: {
      ...
      bn: "উপবাস আমাদের সাংস্কৃতিক ঐতিহ্যের সাথে সংযুক্ত করে, সম্প্রদায়ের বন্ধন শক্তিশালী করে এবং ভবিষ্যত প্রজন্মের জন্য প্রাচীন ঐতিহ্য সংরক্ষণ করে"
    }
  },
  navratriFastingSignificance: {
    purpose: {
      ...
      bn: "নবরাত্রি উপবাস দেবী দুর্গার নয়টি রূপের সম্মান জানাতে, সুরক্ষা, সমৃদ্ধি এবং আধ্যাত্মিক বৃদ্ধির জন্য তার আশীর্বাদ লাভের জন্য পালন করা হয়"
    },
    benefits: {
      ...
      bn: "দিব্য সুরক্ষা আনে, বাধা দূর করে, ইচ্ছা পূরণ করে, কর্ম শুদ্ধ করে এবং আধ্যাত্মিক বিবর্তন ত্বরান্বিত করে"
    },
    spiritualAspects: {
      ...
      bn: "নিদ্রিত আধ্যাত্মিক শক্তি (কুণ্ডলিনী) জাগ্রত করে, চক্রগুলিকে ভারসাম্যপূর্ণ করে এবং দিব্য মাতার সাথে যোগাযোগের সুবিধা প্রদান করে"
    }
  },
  ...
  allowedFoods: {
    ...
    bn: [
      ...
      "বাদাম ও শুকনো ফল",
      "বাকউইট আটা (কুট্টু)",
      "জল চেস্টনাট আটা (সিঙ্গাড়া)",
      "অ্যামারান্থ (রাজগিরা)",
      "বার্নইয়ার্ড বাজরা (সামা)",
      "আলু ও মিষ্টি আলু",
      "কুমড়ো ও লাউ",
      "টমেটো",
      "পাথরের লবণ (সেন্ধা নমক)",
      "নারকেল",
      "মধু ও গুড়"
    ]
  },
  forbiddenFoods: {
    ...
    bn: [
      ...
      "হলুদ, লাল মরিচের গুঁড়ো জাতীয় মশলা",
      "হিং"
    ]
  },
  dailySchedule: {
  ...
  healthConsiderations: {
    benefits: {
      ...
      bn: "হজমশক্তি উন্নত করে, রোগ প্রতিরোধ ক্ষমতা বাড়ায়, শরীরকে বিষমুক্ত করে, মানসিক স্পষ্টতা বাড়ায়, প্রদাহ কমায় এবং ওজন ব্যবস্থাপনাকে উৎসাহিত করে"
    },
    precautions: {
      ...
      bn: "জলীয় পদার্থ গ্রহণ করুন, অতিরিক্ত পরিশ্রম এড়িয়ে চলুন, আপনার শরীরের কথা শুনুন, ইলেক্ট্রোলাইট ভারসাম্য বজায় রাখুন এবং প্রয়োজনে স্বাস্থ্য সেবা প্রদানকারীর পরামর্শ নিন"
    },
    whoShouldAvoid: {
      ...
      bn: "গর্ভবতী ও স্তন্যদানকারী মহিলা, ১২ বছরের কম বয়সী শিশু, স্বাস্থ্য সমস্যা আছে এমন বয়স্ক ব্যক্তি, ডায়াবেটিস রোগী এবং খাদ্যাভ্যাসের সমস্যা আছে এমন ব্যক্তিদের কঠোর উপবাস এড়ানো উচিত"
    }
  },
  modernAdaptations: {
    workingProfessionals: {
      ...
      bn: "হালকা খাবার অন্তর্ভুক্ত করে উপবাস পরিবর্তন করুন, জলীয় পদার্থ গ্রহণ করুন, ভারী শারীরিক কাজ এড়িয়ে চলুন এবং উৎপাদনশীলতার জন্য শক্তির মাত্রা বজায় রাখুন"
    },
    students: {
      ...
      bn: "বাদাম ও ফল জাতীয় মস্তিষ্কের জন্য উপকারী খাবার অন্তর্ভুক্ত করুন, পড়াশোনার সময়সূচী বজায় রাখুন, উপবাসের সময় রাতের পড়াশোনা এড়িয়ে চলুন"
    },
    elderly: {
      ...
      bn: "উপবাসের আগে ডাক্তারের পরামর্শ নিন, স্বাস্থ্যের অবস্থা অনুযায়ী পরিবর্তন করুন, পর্যাপ্ত পুষ্টি নিশ্চিত করুন, সম্পূর্ণ উপবাস এড়িয়ে চলুন"
    },
    children: {
      ...
      bn: "১২ বছরের কম বয়সী শিশুদের কঠোর উপবাস করা উচিত নয়, প্রার্থনা ও সাংস্কৃতিক কার্যক্রমে অংশ নিতে পারে, নিয়মিত পুষ্টিকর খাবার বজায় রাখুন"
    }
  }
};